...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Pil = new QRadioButton(groupBox_2);
        Pil->setObjectName(QStringLiteral("Pil"));
        Pil->setGeometry(QRect(20, 180, 82, 17));
        col = new QRadioButton(groupBox_2);
        col->setObjectName(QStringLiteral("col"));
        col->setGeometry(QRect(20, 200, 82, 17));
        lista = new QRadioButton(groupBox_2);
        lista->setObjectName(QStringLiteral("lista"));
        lista->setGeometry(QRect(20, 220, 161, 17));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Pil->setText(QApplication::translate("MainWindow", "Pila", Q_NULLPTR));
        col->setText(QApplication::translate("MainWindow", "Cola", Q_NULLPTR));
